...
$config['tables']['groups']          = 'autoridade';
$config['tables']['users_groups']    = 'usuario_autoridade';
 ...
 */
$config['site_title']                 = "sigeq.com";       // Site Title, example.com
$config['admin_email']                = "vitorgreati@hotmail.com"; // Admin Email, admin@example.com
$config['default_group']              = 'u_lab';           // Default group, use name
$config['admin_group']                = 'g_usu';             // Default administrators group, use name
